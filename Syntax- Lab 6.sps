...
COMPUTE Chisquared=IDF.CHISQ(pval, 28).
EXECUTE.

* Chart Builder.
GGRAPH
  /GRAPHDATASET NAME="graphdataset" VARIABLES=MAH_1 Chisquared MISSING=LISTWISE REPORTMISSING=NO
  /GRAPHSPEC SOURCE=INLINE
  /FITLINE TOTAL=YES.
BEGIN GPL
  SOURCE: s=userSource(id("graphdataset"))
  DATA: MAH_1=col(source(s), name("MAH_1"))
  DATA: Chisquared=col(source(s), name("Chisquared"))
  GUIDE: axis(dim(1), label("Mahalanobis Distance"))
  GUIDE: axis(dim(2), label("Chisquared"))
  GUIDE: text.title(label("Simple Scatter of Chisquared by Mahalanobis Distance"))
  ELEMENT: point(position(MAH_1*Chisquared))
END GPL.
...
save results /outfile= 'C:\Users\jonna\OneDrive\Dokument\Lund Universitet\Master Global Studies\SIMM32\Lab 6screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= 'C:\Users\jonna\OneDrive\Dokument\Lund Universitet\Master Global Studies\SIMM32\Lab 6screedata.sav'.
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar22 ar23 ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar22 ar23 ar24 ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 ar20 
    ar23 ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 ar20 
    ar23 ar24 ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT BLANK(.30)
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 ar23 
    ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 ar23 
    ar24 ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT BLANK(.30)
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar23 ar24 
    ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar23 ar24 
    ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT BLANK(.30)
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar23 ar24 
    ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar23 ar24 ar25 
    ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT BLANK(.30)
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar19 ar20 ar23 ar24 ar25 
    ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar19 ar20 ar23 ar24 ar25 ar26 
    ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT BLANK(.30)
  /PLOT EIGEN
